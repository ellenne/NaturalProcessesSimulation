...
# or an abstract node of the quad-tree if it has child.
    ...
    # Please note that in a 3D, the octave should be implemented
    # https://www.youtube.com/watch?v=5sJdfciNM20
...
for i in range(max_iter):
    ...
    if i == 500:
        answer = format(bodies[0].pos()[2], '.4f')
        print(f"The z-component of the first body is {answer}")
